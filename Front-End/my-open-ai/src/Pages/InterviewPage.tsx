    ...
    <div className="m-auto w-2/3 mt-16 ">
      {!isQuestionPage && (
        <h1 className="font-extrabold text-transparent text-center text-5xl bg-clip-text bg-gradient-to-r from-purple-300 to-pink-700">
          Let's Start: Enter the Interview Arena and Demonstrate Your Abilities!"
        </h1>
      )}

      {isQuestionPage ? (
        <Question sevectValue={sevectValue} />
      ) : (
        <div>
          <div className="mt-20 text-center">
            <label className="block mb-5 text-center text-xl font-medium text-gray-900 dark:text-white">
              Select Your Track
            </label>
            <select
