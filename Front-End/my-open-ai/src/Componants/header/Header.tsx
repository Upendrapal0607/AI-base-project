...
import bg from '../../assets/background-image-for-ai-based-interview-practice-platform.jpg';
...
export const Header: React.FC<HeaderProps> = () => (
  <div className="techsphere__header section__padding" id="home">
    <div
      className="techsphere__header-content bg-cover bg-center bg-no-repeat rounded-lg" 
